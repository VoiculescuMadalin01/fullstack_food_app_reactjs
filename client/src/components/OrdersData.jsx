...
function OrdersData({index, data, admin}) {
                    ...
                    {admin && (
                        <div className="flex items-center justify-center gap-2">
                            ...
                            <motion.p
                                ...
                                className={`text-orange-500 text-base font-semibold capitalize border border-t-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
                            >
                                Preparing
                            </motion.p>
                            <motion.p
                                {...buttonClick}
                                onClick={() =>
                                    handleClick(data.orderId, "cancelled")
                                }
                                className={`text-red-500 text-base font-semibold capitalize border border-t-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
                            >
                                Cancelled
                            </motion.p>
                            <motion.p
                                {...buttonClick}
                                onClick={() =>
                                    handleClick(data.orderId, "delivered")
                                }
                                className={`text-emerald-500 text-base font-semibold capitalize border border-t-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
                            >
                                Deliveried
                            </motion.p>
                        </div>
